...
then
    ...
    then
        declare -A files
        files[0,5,0,0]="test"
        files[0,5,0,1]="bc62d4b80d9e36da29c16c5d4d9f11731f36052c72401a76c23c0fb5a9b74423"
    fi
    ...
    then
        # File
        ./client/client -UIPort=${UIPorts[0]} -file="${files[0,5,0,0]}"
        ...
        then
            ...
            sleep 10
            # Request the file
            ./client/client -UIPort=${UIPorts[5]} -file="${files[0,5,0,0]}2" -request="${files[0,5,0,1]}" -dest="${outputFiles[0]:0:1}"
        fi
    fi
